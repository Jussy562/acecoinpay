  ...
  return (
    <div className='flex flex-row justify-between items-center w-full'>
        <div className='flex flex-row gap-3 items-center md:w-3/4'>
            <div className='p-2 bg-blue-500 rounded-full text-lg md:text-xl text-white'>
                <HiCreditCard />
            </div>
            <h4 className='text-gray-500 text-xl md:text-2xl'><span className='text-black font-bold'>AceCoin</span>Pay</h4>
        </div>
